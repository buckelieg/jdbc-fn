...
final class ConnectionWrapper implements Connection {

  private final Connection connection;
  private final ConnectionMetadata metadata;

  ConnectionWrapper(Connection connection) throws SQLException {
	this.connection = connection;
	this.metadata = ConnectionMetadata.of(connection);
  }
