 ...
 * the two-arity specialization of {@link TryPredicate}.
 *
...
public interface TryBiPredicate<I1, I2, E extends Throwable> {
     ...
     * predicate
     */
    default TryBiPredicate<I1, I2, E> negate() throws E {
    ...
    static <I1, I2, E extends Throwable> TryBiPredicate<I1, I2, E> of(TryBiPredicate<I1, I2, E> tryBiPredicate) {
        Objects.requireNonNull(tryBiPredicate);
        return tryBiPredicate;
    }
}
